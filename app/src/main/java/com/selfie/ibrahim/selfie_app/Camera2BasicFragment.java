...
public class Camera2BasicFragment extends Fragment
  ...
  private static final SparseIntArray ORIENTATIONS = new SparseIntArray();//Conversion from screen rotation to JPEG orientation.
  ...
  private CameraDevice mCameraDevice;//reference to the opened {@link CameraDevice}.
  ...
  private ImageReader mImageReader;//An {@link ImageReader} that handles image capture.
  ...
  /** {@link CameraCaptureSession.CaptureCallback} that handles events related to capture. */
...
//TODO setPermission
  ...
  private void classifyFrame() {
    ...
    String textToShow = mClassifier.classifyFrame(bitmap);
    bitmap.recycle();
  ...
  /**
   * TODO Initiate a still image capture.
   */
  private void takePicture() {
    lockFocus();
  }
  /**
   * TODO Lock the focus as the first step for a still image capture.
   */
  ...
  /**
   * TODO Run the precapture sequence for capturing a still image. This method should be called when
  ...
  /**
   * TODO Capture a still picture. This method should be called when we get a response in
  ...
  /**
   * TODO Retrieves the JPEG orientation from the specified screen rotation.
   *
  ...
  /**
   * TODO Unlock the focus. This method should be called when still image capture sequence is
   * finished.
   */
  ...
  /**
   * TODO Saves a JPEG {@link Image} into the specified {@link File}.
   */
  ...
  /**
   *TODO Shows OK/Cancel confirmation dialog about camera permission.
   */
